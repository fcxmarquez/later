...
export const imageUrl = (
  ...
  path.startsWith("http")
    ? path
    : `https://image.tmdb.org/t/p/${size === "poster" ? "w500" : "original"}${path}`;
...
export const fallbackCatalog: MediaItem[] = [
  featured,
  {
    ...
    overview:
      "Nueve familias nobles luchan por el control de las tierras de Poniente.",
  ...
  },
  {
    ...
    overview:
      "Un grupo de amigos descubre fuerzas sobrenaturales y experimentos secretos.",
  ...
  },
  {
    ...
    overview:
      "Paul Atreides se une a Chani y los Fremen mientras busca venganza.",
  ...
  },
  {
    ...
    overview: "Joel y Ellie atraviesan unos Estados Unidos devastados.",
  ...
  },
  {
    ...
    overview: "Batman se enfrenta a un criminal que siembra el caos en Gotham.",
  ...
  },
  {
    ...
    overview:
      "La historia de la casa Targaryen doscientos años antes de Game of Thrones.",
